...
export class ProductCard extends HTMLElement {
  constructor(){
    ...
    connectedCallback() {
        ...
        const customTitle = this.getAttribute('customTitle') || 'No Title';
        const customDesc = this.getAttribute('customDesc') || 'No Title';
        ...
        this.innerHTML = createProductCard(img, isRevers, backgroundColor, textColor, title, description, buttonTitle, buttonLink,customTitle,customDesc);
    }
}
