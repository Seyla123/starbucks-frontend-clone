...
const createMugsComponent = (title) => {
	let productCount = 1;
...
class MugsProduct extends HTMLElement {
	connectedCallback() {
		const title = this.getAttribute('title');
		this.innerHTML = createMugsComponent(title);
	}
}

customElements.define('mugs-component', MugsProduct);
