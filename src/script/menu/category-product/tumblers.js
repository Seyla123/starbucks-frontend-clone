...
const createTumblersComponent = (title) => {
	let productCount = 1;
...
class TumblersProduct extends HTMLElement {
	connectedCallback() {
		const title = this.getAttribute('title');
		this.innerHTML = createTumblersComponent(title);
	}
}

customElements.define('tumblers-component', TumblersProduct);
