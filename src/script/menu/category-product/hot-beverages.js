const hotBeveragesProducts = [
	{
		sectionTitle: 'Hot Chocolates',
		products: [
			{
				name: 'Hot Chocolates',
			},
...
const createHotBeveragesProduct = (title) => {
	let productCount = 1;
            ...
            ${hotBeveragesProducts
                        ...
                        <div class="mt-10">
                              ...
                              <div class="grid md:grid-cols-4 grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 lg:gap-10 gap-4 gap-y-14 my-14">
                                 ...
                                 ${product.products
																		.map((item) => {
																			const imgSrc = `../../images/menu/hot-beverages-img/p${productCount++}.jpg`;
...
class HotBeveragesProduct extends HTMLElement {
	connectedCallback() {
		const title = this.getAttribute('title');
		this.innerHTML = createHotBeveragesProduct(title);
	}
}

customElements.define('hot-beverages-component', HotBeveragesProduct);
