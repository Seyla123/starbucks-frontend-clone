...
const createOtherProduct = (title) => {
	let productCount = 1;
...
class OtherProduct extends HTMLElement {
	connectedCallback() {
		const title = this.getAttribute('title');
		this.innerHTML = createOtherProduct(title);
	}
}

customElements.define('other-component', OtherProduct);
