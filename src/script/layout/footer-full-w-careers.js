// Footer
const footerFullWCareer = document.querySelector(".footer-full-w-careers-layout");
fetch("../../components/layout/footer-full-w-careers.html")
  .then((res) => res.text())
  .then((data) => {
    footerFullWCareer.innerHTML = data;
