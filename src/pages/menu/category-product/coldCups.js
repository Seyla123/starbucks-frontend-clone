...
const createColdCupsComponent = (title) => {
	let productCount = 1;
...
class ColdCupsProduct extends HTMLElement {
	connectedCallback() {
		const title = this.getAttribute('title');
		this.innerHTML = createColdCupsComponent(title);
	}
}

customElements.define('cold-cups-component', ColdCupsProduct);
